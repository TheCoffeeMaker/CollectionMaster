...
function initModels(sequelize) {
  ...
  var inventory_transaction_types = _inventory_transaction_types(sequelize, DataTypes);
  ...
  privileges.belongsToMany(employees, { through: employee_privileges, foreignKey: "privilege_id", otherKey: "employee_id" });
  employees.belongsToMany(privileges, { through: employee_privileges, foreignKey: "employee_id", otherKey: "privilege_id" });
  ...
  inventory_transactions.belongsTo(inventory_transaction_types, { foreignKey: "transaction_type"});
  inventory_transaction_types.hasMany(inventory_transactions, { foreignKey: "transaction_type"});
  ...
  inventory_transactions.belongsTo(purchase_orders, { foreignKey: "purchase_order_id"});
  purchase_orders.hasMany(inventory_transactions, { foreignKey: "purchase_order_id"});
  ...
  purchase_order_details.belongsTo(purchase_orders, { foreignKey: "purchase_order_id"});
  purchase_orders.hasMany(purchase_order_details, { foreignKey: "purchase_order_id"});
  ...
  purchase_order_details.belongsTo(inventory_transactions, { foreignKey: "inventory_id"});
  inventory_transactions.hasMany(purchase_order_details, { foreignKey: "inventory_id"});
