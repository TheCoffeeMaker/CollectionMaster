    ...
    return (
        <tr>
            ...
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedProduct.id ?
                        <Edit value={updatedProduct.product_code}
                            id={'product_code'}
                            onChangeHandler={(newValue) => onPropertyChange('product_code', updatedProduct, newValue)} />
                        :
            ...
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedProduct.id ?
                        <Edit value={updatedProduct.product_name}
                            id={'product_name'}
                            onChangeHandler={(newValue) => onPropertyChange('product_name', updatedProduct, newValue)} />
                        :
            ...
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedProduct.id ?
                    <Edit value={updatedProduct.standard_cost}
                        id={'standard_cost'}
                        onChangeHandler={(newValue) => onPropertyChange('standard_cost', updatedProduct, newValue)} />
                    :
