    ...
    return (
        <tr>
            ...
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedCustomer.id ?
                        <Edit value={updatedCustomer.first_name}
                            id={'first_name'}
                            onChangeHandler={(newValue) => onPropertyChange('first_name', updatedCustomer, newValue)} /> :
            ...
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedCustomer.id ?
                        <Edit value={updatedCustomer.last_name}
                            id={'last_name'}
                            onChangeHandler={(newValue) => onPropertyChange('last_name', updatedCustomer, newValue)} /> :
            ...
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedCustomer.id ?
                        <Edit value={updatedCustomer.company}
                            id={'company'}
                            onChangeHandler={(newValue) => onPropertyChange('company', updatedCustomer, newValue)} /> :
