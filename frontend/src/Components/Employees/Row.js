...
export function Row(props) {
    ...
    return (
        <tr>
            <th scope="row">{updatedEmployee.id}</th>
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedEmployee.id ?
                        <Edit value={updatedEmployee.first_name}
                            id={'first_name'}
                            onChangeHandler={(newValue) => onPropertyChange('first_name', updatedEmployee, newValue)} /> :
            ...
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedEmployee.id ?
                        <Edit value={updatedEmployee.last_name}
                            id={'last_name'}
                            onChangeHandler={(newValue) => onPropertyChange('last_name', updatedEmployee, newValue)} /> :
            ...
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedEmployee.id ?
                        <Edit value={updatedEmployee.company}
                            id={'company'}
                            onChangeHandler={(newValue) => onPropertyChange('company', updatedEmployee, newValue)} /> :
            ...
            <td>
                {
                    isEditMode && props.selectedRowIndex === updatedEmployee.id ?
                        <div className="btn-group" role="group">
                            <SaveButton saveHandler={() => save(updatedEmployee)} />
