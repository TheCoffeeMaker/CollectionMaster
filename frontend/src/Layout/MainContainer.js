        ...
        <Router>
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                    <NavLink className="navbar-brand" to="/">Main Menu</NavLink>
                    <div className="collapse navbar-collapse">
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <NavLink className="nav-link" activeClassName="active" to="/customers">Customers list</NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink className="nav-link" activeClassName="active" to="/employees">Employees list</NavLink>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link" activeClassName="active" to="/suppliers">Suppliers</NavLink>
                            </li>
                        </ul>
                    </div>
